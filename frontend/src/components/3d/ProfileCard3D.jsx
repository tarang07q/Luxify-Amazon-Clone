...
/**
 * A specialized 3D profile card icon component
...
const ProfileCard3D = ({
  ...
  const displayIcon = icon || <FaUser size={size/4} />;
      ...
      >
        <div className="profile-card-3d">
          <div className="profile-card-body" style={{
            ...
            <div className="profile-card-logo">A</div>
            <div className="profile-card-number">**** **** **** 1234</div>
